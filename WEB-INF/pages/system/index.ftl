   ...
   <div id="wrapper">    
      <div ng-controller="MainCtrl as mainCtrl" >
        ...
        <nav class="navbar-canvas navbar-default navbar-fixed-top" role="navigation" >
          ...
          <ul class="nav navbar-top-links-v2 navbar-right margintop13 visible-print " >
      ...
      <div>
        <div id="page-wrapper" class="start" autoscroll ng-init="$root.resizeSideBar()" ng-mouseover="navbarMobileToggleOut(); " >
