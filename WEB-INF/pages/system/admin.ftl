      ...
      <div ng-controller="MainCtrl as mainCtrl" >
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="min-height: 50px;">
          ...
          <div class="navbar-header">
          	<a href="#"><img src="images/logo.png" title="Your Logo Here" style="background-size:contain; height: 40px; margin-top:5px; margin-left: 10px;"></img></a>
          </div>
          ...
          <ul class="nav navbar-top-links navbar-right" style="margin-top: 0px;">
              <li>
                ...
                <li class="navbar-toggle-item">
                  <button type="button" class="navbar-toggle" ng-click="navbarToggle()">
