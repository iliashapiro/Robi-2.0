...
(function(root, factory) {
  ...
  .factory('rzThrottle', ['$timeout', '$rootScope' , function($timeout, $rootScope) {
    /**
     * rzThrottle
     *
  ...
  .factory('RzSlider', ['$timeout', '$document', '$window', '$compile', 'RzSliderOptions', 'rzThrottle','serviceDriver', function($timeout, $document, $window, $compile, RzSliderOptions, rzThrottle, serviceDriver) {
    'use strict';
    ...
    Slider.prototype = {
      ...
      init: function() {
        ...
        this.scope.$on('rzSliderForceRender', function() {
         ...
         this.scope.$on('monthChange', function() {
          console.log("listening for sliderforcerender");
      ...
      positionTrackingBar: function(newMinValue, newMaxValue) {
        ...
        serviceDriver.minFilterRange = newMinValue;
        serviceDriver.maxFilterRange = newMaxValue;
        ...
        console.log(newMinValue, newMaxValue, "new datatatatatatatatatatatatat");
      ...
      positionTrackingHandle: function(newValue) {
        ...
        if(this.tracking === 'lowValue' ){
          serviceDriver.minFilterRange = newValue;
           console.log(serviceDriver.minFilterRange , serviceDriver.maxFilterRange , "%%%%%%%%%%%555555555555%%%%%%%%%%%%%");
        }else{
          if(this.tracking === 'highValue'  ){
            serviceDriver.maxFilterRange = newValue;
             console.log(serviceDriver.minFilterRange , serviceDriver.maxFilterRange , "%%%%%%%%%%%555555555555%%%%%%%%%%%%%");
          }else{
        ...
        if (this.range) {
          if (this.options.pushRange) {
            ...
            if (this.tracking === 'lowValue' && newValue > this.highValue) {
              ...
              //serviceDriver.maxFilterRange = this.highValue;
              if (this.options.keyboardSupport)
              ...
              //serviceDriver.minFilterRange = this.lowValue;
              if (this.options.keyboardSupport)
  ...
  .directive('rzslider', ['RzSlider','serviceDriver', function(RzSlider, serviceDriver) {
    'use strict';
    ...
    return {
      ...
      link: function(scope, elem) {
        ...
        $("#desktopslider").click(function(e){
            console.log("&&&&&&&&&&&&&&&&&&&&&&&&&&&&")
            scope.slider.positionTrackingBar( (serviceDriver.minFilterRange), (serviceDriver.maxFilterRange) )
        });
        
        
        $( "#rzslider" ).scroll(function(e) { 
          //console.log(e.target.scrollLeft, "scrollLEFT$$$$$$$$$$  %%%%%%%%%%%%%%%%%%%" );
        var tempitemwidth = (e.target.getBoundingClientRect().width / 12)*2;
        
        var temptoffset = Math.round(e.target.scrollLeft / tempitemwidth);
        if( serviceDriver.minFilterRange < temptoffset){
           // scope.slider.positionTrackingBar( (serviceDriver.minFilterRange+1), (serviceDriver.maxFilterRange+1) );
        }else if(serviceDriver.maxFilterRange > (temptoffset+6)){
          ...
          console.log(Math.round(temptoffset) ," tempitemwidthtempitemwidthtempitemwidthtempitemwidth");
